...
$(function () {
            ...
            describe('RSS Feeds', function () {
                 ...
                 */
                it('urls are notEmpty', function () {
                    allFeeds.forEach(feed => {

                        expect(allFeeds.url).toBeDefined();
                        expect(allFeeds.url.length).not.toBe(0);
                        expect(allFeeds.url).toMatch(/^(html|https):\/\//);
                    });
                ...
                describe('Initial Entries', function () {
                    ...
                    it('there is at least a single. entry within the feed container after loadfeed is called and completed', function (done) {
                        const Entries = document.querySelector('.feed').getElementsByClassName('.entry.length');
                        expect(Entries).toBeGreatherThan(0);
                        done();
                    });
                       ...
                       let actualFeedSelection;
                        beforeEach,function (done){
                            loadFeed(0, function() {
                                ...
                                it('by load a new feed the content changes'), function (done) {
